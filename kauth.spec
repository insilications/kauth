...
Source0  : https://download.kde.org/stable/frameworks/5.56/kauth-5.56.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.56/kauth-5.56.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1552157462
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Auth.so.5.56.0
/usr/lib64/libKF5AuthCore.so.5
/usr/lib64/libKF5AuthCore.so.5.56.0
